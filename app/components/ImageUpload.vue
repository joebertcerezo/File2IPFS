  ...
  <div>
    ...
    <div ref="imageDropZone" :class="[
      ...
      <div class="flex flex-col items-center space-y-4">
        ...
        <!-- File Input -->
        <Input @change="handleImageSelect" type="file" accept="image/*"
        ...
        <div>
          ...
          <div class="space-y-2 text-sm">
            <div class="flex space-x-2">
              <a :href="ipfsData?.ipfsUrl" target="_blank" class="text-purple-400 hover:text-purple-300 underline">
                View on IPFS
              </a>
              <span class="text-slate-500">|</span>
              <a :href="ipfsData?.gatewayUrl" target="_blank" class="text-purple-400 hover:text-purple-300 underline">
                Gateway URL
              </a>
            </div>
          </div>
...
const imageDropZone = useTemplateRef<HTMLElement>("imageDropZone");
